...
<div id='panel-bottom'>
		...
		<div style='background:#540303;color:#160000;text-shadow:1px 1px #660202;padding:5px 3px;font-family:Arial;'>Страници</div>
		<a href='./?p=new_page'><img src='../images/icons/shape_square_add.png' width='16' /> Нова страница</a> <br/>
		<a href='./?p=new_page&w=list'><img src='../images/icons/blogs.png' width='16' /> Списък със страници</a> <br/>
		
		<br/>
	
		
		<div style='background:#540303;color:#160000;text-shadow:1px 1px #660202;padding:5px 3px;font-family:Arial;'>Форум</div>
		<a href='./?p=forum-settings'><img src='../images/icons/hammer.png' width='16' /> Настойки на форума</a> <br/>
		<a href='./?p=forum-cats'><img src='../images/icons/hammer.png' width='16' /> Категории</a> <br/>
		<br/>
		<a href='./?p=forum-locked-posts'><img src='../images/icons/lock.png' width='16' /> Заключени теми</a> <br/>
		<a href='./?p=forum-reported-posts'><img src='../images/icons/closed_small.png' width='16' /> Докладвани теми</a> <br/>
